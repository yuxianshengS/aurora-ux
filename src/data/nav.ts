...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'FloatButton 悬浮按钮', path: '/docs/float-button' },
      { title: 'Icon 图标', path: '/docs/icon' },
      { title: 'Text 文本', path: '/docs/text' },
      { title: 'Kbd 键帽', path: '/docs/kbd' },
    ],
  },
  {
    title: '数据录入',
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Watermark 水印', path: '/docs/watermark' },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'AuroraCursor 鼠标极光', path: '/docs/aurora-cursor' },
      { title: 'Confetti 庆祝粒子', path: '/docs/confetti' },
  ...
  },
  {
    title: '生产力',
    items: [
      { title: 'CommandPalette ⌘K 命令面板', path: '/docs/command-palette' },
      { title: 'Theme Studio · 主题调色台', path: '/docs/theme-studio' },
    ],
  },
  {
    title: '图与拓扑',
